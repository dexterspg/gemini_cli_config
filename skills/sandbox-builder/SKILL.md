...
description: 'Full rules, process, output structure, and checklists for building learning sandboxes in --sandbox mode. MANDATORY: Load before starting any sandbox session. Triggers on "build me a sandbox", "isolate X so I can learn it", "extract X into a runnable example", "mini-app for X", "--sandbox" flag.'
---
